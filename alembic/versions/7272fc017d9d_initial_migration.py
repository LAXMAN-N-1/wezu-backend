...
Revision ID: 7272fc017d9d
Revises: 
Create Date: 2026-04-01 14:57:46.950689
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_api_key_configs_service_name'), 'api_key_configs', ['service_name'], unique=False)
    ...
    sa.Column('template_message', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_automated_triggers_event_type'), 'automated_triggers', ['event_type'], unique=False)
    ...
    op.create_index(op.f('ix_bess_units_name'), 'bess_units', ['name'], unique=False)
    op.create_index(op.f('ix_bess_units_status'), 'bess_units', ['status'], unique=False)
    ...
    sa.Column('year_established', sa.String(), nullable=True),
    ...
    sa.Column('global_station_defaults', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True),
    sa.Column('global_inventory_rules', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True),
    sa.Column('holiday_calendar', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index(op.f('ix_notification_configs_provider'), 'notification_configs', ['provider'], unique=False)
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'SUSPENDED', 'PENDING_VERIFICATION', 'PENDING', 'INACTIVE', 'VERIFIED', 'DELETED', name='userstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['created_by_dealer_id'], ['dealer_profiles.id'], ),
    ...
    sa.Column('is_superuser', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('admin_group_id', sa.Integer(), nullable=True),
    ...
    op.create_table('bess_energy_logs',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('soc_start', sa.Float(), nullable=False),
    sa.Column('soc_end', sa.Float(), nullable=False),
    ...
    op.create_index(op.f('ix_bess_energy_logs_bess_unit_id'), 'bess_energy_logs', ['bess_unit_id'], unique=False)
    op.create_index(op.f('ix_bess_energy_logs_timestamp'), 'bess_energy_logs', ['timestamp'], unique=False)
    op.create_table('bess_grid_events',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('bess_unit_id', sa.Integer(), nullable=False),
    sa.Column('event_type', sa.String(), nullable=False),
    sa.Column('status', sa.String(), nullable=False),
    ...
    sa.Column('target_power_kw', sa.Float(), nullable=False),
    sa.Column('actual_power_kw', sa.Float(), nullable=True),
    sa.Column('energy_kwh', sa.Float(), nullable=True),
    sa.Column('revenue_earned', sa.Float(), nullable=True),
    sa.Column('grid_operator', sa.String(), nullable=True),
    sa.Column('notes', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['bess_unit_id'], ['bess_units.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_bess_grid_events_bess_unit_id'), 'bess_grid_events', ['bess_unit_id'], unique=False)
    op.create_index(op.f('ix_bess_grid_events_event_type'), 'bess_grid_events', ['event_type'], unique=False)
    op.create_table('bess_reports',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('bess_unit_id', sa.Integer(), nullable=True),
    sa.Column('report_type', sa.String(), nullable=False),
    sa.Column('period_start', sa.DateTime(), nullable=False),
    sa.Column('period_end', sa.DateTime(), nullable=False),
    sa.Column('total_charged_kwh', sa.Float(), nullable=False),
    sa.Column('total_discharged_kwh', sa.Float(), nullable=False),
    sa.Column('avg_efficiency', sa.Float(), nullable=False),
    sa.Column('peak_power_kw', sa.Float(), nullable=False),
    sa.Column('avg_soc', sa.Float(), nullable=False),
    sa.Column('min_soc', sa.Float(), nullable=False),
    sa.Column('max_soc', sa.Float(), nullable=False),
    sa.Column('revenue', sa.Float(), nullable=False),
    sa.Column('cost', sa.Float(), nullable=False),
    sa.Column('grid_events_count', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['bess_unit_id'], ['bess_units.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_bess_reports_report_type'), 'bess_reports', ['report_type'], unique=False)
    ...
    op.create_index(op.f('ix_push_campaigns_status'), 'push_campaigns', ['status'], unique=False)
    ...
    sa.ForeignKeyConstraint(['campaign_id'], ['push_campaigns.id'], ),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['product_id'], ['battery_catalog.id'], ),
    ...
    op.create_foreign_key('fk_dealer_profiles_user_id', 'dealer_profiles', 'users', ['user_id'], ['id'])

def downgrade() -> None:
    op.drop_constraint('fk_dealer_profiles_user_id', 'dealer_profiles', type_='foreignkey')
    # ### commands auto generated by Alembic - please adjust! ###
    ...
    op.drop_index(op.f('ix_push_campaigns_status'), table_name='push_campaigns')
    ...
    op.drop_index(op.f('ix_bess_reports_report_type'), table_name='bess_reports')
    op.drop_table('bess_reports')
    op.drop_index(op.f('ix_bess_grid_events_event_type'), table_name='bess_grid_events')
    op.drop_index(op.f('ix_bess_grid_events_bess_unit_id'), table_name='bess_grid_events')
    op.drop_table('bess_grid_events')
    op.drop_index(op.f('ix_bess_energy_logs_timestamp'), table_name='bess_energy_logs')
    op.drop_index(op.f('ix_bess_energy_logs_bess_unit_id'), table_name='bess_energy_logs')
    op.drop_table('bess_energy_logs')
    ...
    op.drop_index(op.f('ix_notification_configs_provider'), table_name='notification_configs')
    ...
    op.drop_index(op.f('ix_bess_units_status'), table_name='bess_units')
    op.drop_index(op.f('ix_bess_units_name'), table_name='bess_units')
    ...
    op.drop_index(op.f('ix_automated_triggers_event_type'), table_name='automated_triggers')
    ...
    op.drop_index(op.f('ix_api_key_configs_service_name'), table_name='api_key_configs')

...
Revision ID: 3e3d655d355d
Revises: 
Create Date: 2026-03-23 08:43:23.914034
...
def upgrade() -> None:
    ...
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('currency', sa.String(), nullable=False),
    sa.Column('transaction_type', sa.Enum('RENTAL_PAYMENT', 'SECURITY_DEPOSIT', 'WALLET_TOPUP', 'REFUND', 'FINE', 'SUBSCRIPTION', 'WITHDRAWAL', 'PURCHASE', 'SWAP_FEE', 'LATE_FEE', name='transactiontype'), nullable=False),

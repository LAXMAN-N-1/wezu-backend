    ...
    with Session(engine) as session:
        ...
        for i in range(25):
            ...
            battery = Battery(
                ...
                manufacture_date=datetime.now(UTC) - timedelta(days=random.randint(100, 400)),
                purchase_date=datetime.now(UTC) - timedelta(days=random.randint(50, 100)),
                warranty_expiry=datetime.now(UTC) + timedelta(days=random.randint(200, 700)),
                created_by=admin.id,
            ...
            for j in range(random.randint(3, 8)):
                audit = BatteryAuditLog(
                    ...
                    timestamp=datetime.now(UTC) - timedelta(days=j*10)
                )
                session.add(audit)
            ...
            for k in range(10):
                hist = BatteryHealthHistory(
                    ...
                    recorded_at=datetime.now(UTC) - timedelta(days=(10-k)*7)
                )
                session.add(hist)

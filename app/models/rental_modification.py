...
class RentalExtension(SQLModel, table=True):
    ...
    payment_transaction_id: Optional[int] = Field(default=None, foreign_key="finance.payment_transactions.id")
...
class RentalPause(SQLModel, table=True):
    ...
    battery_returned_to_station_id: Optional[int] = Field(default=None, foreign_key="stations.stations.id")

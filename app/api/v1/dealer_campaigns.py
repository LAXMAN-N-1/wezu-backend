...
def create_campaign(
    ...
    return DealerCampaignService.create_campaign(db, dealer_id, payload)
...
def list_campaigns(
    ...
    dealer_id = _get_dealer_id(db, current_user.id)
    return DealerCampaignService.list_campaigns(db, dealer_id, active_only)
...
def get_campaign(
    ...
    dealer_id = _get_dealer_id(db, current_user.id)
    return DealerCampaignService.get_campaign(db, campaign_id, dealer_id)
...
def update_campaign(
    ...
    return DealerCampaignService.update_campaign(db, campaign_id, dealer_id, payload)
...
def deactivate_campaign(
    ...
    dealer_id = _get_dealer_id(db, current_user.id)
    return DealerCampaignService.toggle_active(db, campaign_id, dealer_id, False)
...
def validate_promo(
    ...
    return DealerCampaignService.validate_promo(
...
def get_campaign_analytics(
    ...
    dealer_id = _get_dealer_id(db, current_user.id)
    return DealerCampaignService.get_analytics(db, campaign_id, dealer_id)
...
async def bulk_create_csv(
    ...
    return DealerCampaignService.bulk_create_from_csv(db, dealer_id, csv_string)
...
def bulk_toggle(
    ...
    dealer_id = _get_dealer_id(db, current_user.id)
    count = DealerCampaignService.bulk_toggle(db, dealer_id, req.campaign_ids, req.is_active)
...
def clone_campaign(
    ...
    dealer_id = _get_dealer_id(db, current_user.id)
    return DealerCampaignService.clone_campaign(db, campaign_id, dealer_id, req.new_promo_code)

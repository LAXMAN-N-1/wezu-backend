...
def test_clustering_endpoint_valid_params(client):
    response = client.get(
...
def test_clustering_endpoint_invalid_zoom(client):
    response = client.get(
        "/api/v1/stations/clusters"
...
def test_expand_cluster_endpoint(client):
    response = client.get(
...
def test_expand_cluster_invalid_id(client):
    response = client.get(
